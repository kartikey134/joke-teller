...
function tellMe(joke) {
	VoiceRSS.speech({
        key: 'f025b05764f94222b5b8508c972358f4',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0,
...
async function getJokes() {
	let joke = '';
	const apiUrl = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,political,racist,sexist&idRange=0-185';
	try {
